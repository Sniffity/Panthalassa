...
public class ModelKronosaurus extends AnimatedGeoModel<EntityKronosaurus>
{
    ...
    public void setLivingAnimations(EntityKronosaurus entity, Integer uniqueID, @Nullable AnimationEvent customPredicate) {
        ...
        (this.getAnimationProcessor().getBone("tail_section_3")).setRotationY((float)(entity.adjustYaw*(PI/180.0F))*3.0F);
        (this.getAnimationProcessor().getBone("tail_section_4")).setRotationY((float)(entity.adjustYaw*(PI/180.0F))*3.0F);
