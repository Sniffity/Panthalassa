...
{
    @Override
    public ResourceLocation getModelLocation(ProjectileTranquilizingTorpedo object) {
        return new ResourceLocation(Panthalassa.MODID,"geo/projectile/torpedo/torpedo.geo.json");
    }

    @Override
    public ResourceLocation getTextureLocation(ProjectileTranquilizingTorpedo object) {
