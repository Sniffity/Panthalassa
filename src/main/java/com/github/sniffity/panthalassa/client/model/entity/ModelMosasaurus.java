...
public class ModelMosasaurus extends AnimatedGeoModel<EntityMosasaurus>
{
    ...
    public void setLivingAnimations(EntityMosasaurus entity, Integer uniqueID, @Nullable AnimationEvent customPredicate) {
        ...
        (this.getAnimationProcessor().getBone("lower_torso")).setRotationY((float)(entity.adjustYaw*(PI/180.0F))*7.0F);
        (this.getAnimationProcessor().getBone("lower_torso_tail")).setRotationY((float)(entity.adjustYaw*(PI/180.0F))*7.0F);
        (this.getAnimationProcessor().getBone("tail_section_1")).setRotationY((float)(entity.adjustYaw*(PI/180.0F))*7.0F);
        (this.getAnimationProcessor().getBone("tail_section_2")).setRotationY((float)(entity.adjustYaw*(PI/180.0F))*7.0F);
        (this.getAnimationProcessor().getBone("neck")).setRotationY((float)(-entity.adjustYaw*(PI/180.0F))*7.0F);
    }
