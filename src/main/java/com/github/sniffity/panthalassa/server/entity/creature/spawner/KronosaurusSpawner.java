...
public class KronosaurusSpawner  {
    ...
    private void spawnInBiome(ServerWorld worldIn, BlockPos blockPos, BlockPos blockPos0, BlockPos blockPos1) {
        ...
        if (worldIn.getBiome(blockPos).getRegistryName() != null) {
            ...
            if (Objects.equals(worldIn.getBiome(blockPos).getRegistryName(), new ResourceLocation(Panthalassa.MODID, "abyssal_overgrowth"))) {
                ...
                List<EntityKronosaurus> list = worldIn.getEntitiesOfClass(EntityKronosaurus.class, (new AxisAlignedBB(blockPos)).inflate(96.0D, 96.0D, 96.0D));
                ...
                List<EntityKronosaurus> list0 = worldIn.getEntitiesOfClass(EntityKronosaurus.class, (new AxisAlignedBB(blockPos)).inflate(36.0D, 64.0D, 36.0D));
    ...
    private void spawnKronosaurus(BlockPos blockPos, BlockPos blockPos0, BlockPos blockPos1, ServerWorld worldIn) {
        ...
        if (kronosaurus1 != null) {
            ...
            if(net.minecraftforge.common.ForgeHooks.canEntitySpawn(kronosaurus, worldIn, blockPos1.getX(), blockPos1.getY(), blockPos1.getZ(), null, SpawnReason.NATURAL) != -1) {
