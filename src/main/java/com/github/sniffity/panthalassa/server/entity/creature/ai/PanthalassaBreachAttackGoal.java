...
public class PanthalassaBreachAttackGoal extends Goal {
    ...
    public void moveStep1() {
        ...
        if ((this.attacker.distanceToSqr(boatTarget.getX(), boatTarget.getY() - 10, boatTarget.getZ())) > 2) {
    ...
    public void tick() {
        if (!step1Done) {
            ...
            this.attacker.setDeltaMovement(this.attacker.getDeltaMovement().add(0, 1.0D, 0));
            step3Done = true;
        } else if (!step4Done) {
