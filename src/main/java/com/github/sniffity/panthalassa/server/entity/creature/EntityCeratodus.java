...
public class EntityCeratodus extends PanthalassaEntity implements IAnimatable, Enemy {
    ...
    public EntityCeratodus(EntityType<? extends PanthalassaEntity> type, Level worldIn) {
        super(type, worldIn);
    ...
    public <E extends IAnimatable> PlayState predicate(AnimationEvent<E> event) {
        if ((this.isOnGround() && !this.isInWater())) {
            event.getController().setAnimation(new AnimationBuilder().addAnimation("animation.ceratodus.beached", true));
    ...
    public static AttributeSupplier.Builder ceratodusAttributes() {
