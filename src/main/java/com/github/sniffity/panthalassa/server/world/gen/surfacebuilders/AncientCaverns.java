...
public class AncientCaverns extends ValleySurfaceBuilder {
    ...
    private static final BlockState FLOOR_BLOCK_1 = PanthalassaBlocks.ANCIENT_ROCK.get().defaultBlockState();


    private static final BlockState PATCH = PanthalassaBlocks.PANTHALASSA_STONE.get().defaultBlockState();

    private static final ImmutableList<BlockState> FLOOR_BLOCK_STATES = ImmutableList.of(FLOOR_BLOCK_1);
