...
/**
 * Panthalassa Mod - Class: PanthalassaBiomeProvider <br></br?>
 *
...
public class PanthalassaBiomeProvider extends NetherBiomeProvider {
    ...
    public BiomeProvider withSeed(long seed) {
        return new PanthalassaBiomeProvider(seed, this.parameters, this.preset);
    }
}
