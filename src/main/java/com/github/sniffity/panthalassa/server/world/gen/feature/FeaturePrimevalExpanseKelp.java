...
public class FeaturePrimevalExpanseKelp extends Feature<NoneFeatureConfiguration> {
    public FeaturePrimevalExpanseKelp(Codec<NoneFeatureConfiguration> p_i231967_1_) {
        super(p_i231967_1_);
    }
