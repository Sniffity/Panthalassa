...
public class ItemMegalodonJawsDisplay extends Item {
    private static final Predicate<Entity> ENTITY_PREDICATE = EntitySelector.NO_SPECTATORS.and(Entity::isPickable);

    public ItemMegalodonJawsDisplay(Item.Properties properties) {
        super(properties);
    }
    ...
    public InteractionResultHolder<ItemStack> use(Level worldIn, Player player, InteractionHand hand) {
        ...
        if (raytraceresult.getType() == HitResult.Type.MISS) {
            ...
            if (raytraceresult.getType() == HitResult.Type.BLOCK) {
                DisplayMegalodonJaws displayEntity = new DisplayMegalodonJaws(PanthalassaEntityTypes.MEGALODON_JAWS.get(), worldIn);
