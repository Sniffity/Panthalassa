...
public class PanthalassaMoveControl extends MoveControl {
    ...
    private final PanthalassaCreature panthalassaCreature;

    public PanthalassaMoveControl(Mob panthalassaCreature, int maxTurnX, float inWaterSpeedModifier, float outsideWaterSpeedModifier, boolean applyGravity) {
        super(panthalassaCreature);
        this.panthalassaCreature = (PanthalassaCreature) panthalassaCreature;
    ...
    public void tick() {
        ...
        if (this.operation == MoveControl.Operation.MOVE_TO && !this.mob.getNavigation().isDone()) {
            ...
            if (d3 < (double) 2.5000003E-7F) {
                ...
                /*
                if ((this.panthalassaCreature instanceof IBreacher && ((IBreacher) this.panthalassaCreature).getBreaching()) ||
                        (this.panthalassaCreature instanceof ICrushable && ((ICrushable) this.panthalassaCreature).getCrushing())) {
                    this.maxTurnY=90;
                }

                 */
                if ((this.panthalassaCreature.getTarget() != null)) {
                    this.maxTurnY = 15;
                } else {
                    this.maxTurnY = 7;
                }
                ...
                if (this.mob.isInWater() || this.mob.level().getBlockState(new BlockPos(mob.blockPosition()).below()).is(Blocks.WATER) || 1 == 1) {
