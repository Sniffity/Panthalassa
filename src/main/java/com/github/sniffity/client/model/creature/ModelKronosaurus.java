...
public class ModelKronosaurus extends GeoModel<CreatureKronosaurus> {
    ...
    public void dynamicYaw1(CreatureKronosaurus entity, AnimationState<CreatureKronosaurus> animationState){
        ...
        (this.getAnimationProcessor().getBone("lower_torso")).setRotY(setYawValue*5.0F);
        (this.getAnimationProcessor().getBone("lower_torso_tail")).setRotY(setYawValue*5.0F);
        (this.getAnimationProcessor().getBone("tail_section_1")).setRotY(setYawValue*5.0F);
        (this.getAnimationProcessor().getBone("tail_section_2")).setRotY(setYawValue*5.0F);
        (this.getAnimationProcessor().getBone("tail_section_3")).setRotY(setYawValue*5.0F);
        (this.getAnimationProcessor().getBone("tail_section_4")).setRotY(setYawValue*5.0F);
        (this.getAnimationProcessor().getBone("neck")).setRotY(-setYawValue*5.0F);
    }
